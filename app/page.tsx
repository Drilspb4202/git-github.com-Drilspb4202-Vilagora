...
import { PackageQuiz } from "@/components/package-quiz"
...
import { PreparationPlan } from "@/components/preparation-plan"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-lg sm:text-xl text-stone-300 mb-8 sm:mb-12 leading-relaxed max-w-4xl mx-auto px-4">
              Мы создаем уникальный опыт для каждого участника, учитывая ваши потребности и предпочтения
            </p>
          </div>

          <div className="space-y-12 sm:space-y-16">
            {/* Квиз для подбора пакета */}
            <div>
              <h3 className="text-2xl sm:text-3xl font-bold text-center mb-8 text-stone-100">
                Найдите свой идеальный пакет
              </h3>
              <PackageQuiz />
            </div>
            ...
            <div>
              <h3 className="text-2xl sm:text-3xl font-bold text-center mb-8 text-stone-100">Активности для вас</h3>
            ...
            {/* План подготовки */}
            <div>
              <h3 className="text-2xl sm:text-3xl font-bold text-center mb-8 text-stone-100">Подготовка к ретриту</h3>
              <PreparationPlan />
            </div>
          </div>
        </div>
